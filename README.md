...
> [!IMPORTANT]  
> You are in **dev** branch of py-ollama, which mean all releases under this branch, have unfinished and/or buggy codes (but still went through adequate amount of testings).
> *"Look I want to have some break time, even though no one uses this program."*
